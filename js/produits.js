...
fetch('http://localhost:3000/api/teddies/' + teddyId)
  ...
  let titleTeddyPage = document.getElementById("teddyName"); 
    ...
    productName.textContent = "Notre Ours : " + teddy.name;
    ...
    productBloc__descriptionText.textContent = teddy.description;
    ...
    productColors.id = teddy.name + "colors";
    ...
    let teddyOnPageColors = teddy.colors;
